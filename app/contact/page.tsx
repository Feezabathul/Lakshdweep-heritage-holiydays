        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 lg:grid-cols-[minmax(0,0.97fr)_minmax(560px,1.03fr)] lg:items-start lg:gap-16">
          <section className="pt-2 lg:pt-8">
            ...
            <div className="mt-10 flex flex-col gap-7 sm:mt-12 sm:gap-8">
              <ContactDetail icon={MapPin} title="Head Office" value="lakshadweep heritage holidays kavaratti island" />
              <ContactDetail icon={Phone} title="Direct Phone & WhatsApp" value="9037532124" />
              <ContactDetail icon={Mail} title="Email Support" value="lakshadweepheritageholidays@gmail.com" />
              <ContactDetail icon={Clock3} title="Business Hours" value="Mon – Sat: 8:00 AM – 9:00 PM IST" />
            </div>
          </section>
